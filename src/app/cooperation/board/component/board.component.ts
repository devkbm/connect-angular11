...
export class BoardComponent implements OnInit {
  ...
  public setBoardSelect(item: any): void {
  ...
  public modifyBoard(item: any): void {
  ...
  public editArticle(item: any): void {
    this.articleForm.getArticle(item.pkArticle);
    this.openArticleDrawer();
  }

  public showArticleView(item: any): void {
